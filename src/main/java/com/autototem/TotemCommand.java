...
public class TotemCommand {
    ...
    private static int setSlot(CommandContext<FabricClientCommandSource> context) {
        ...
        context.getSource().sendFeedback(
            class_2561.method_43470("§6[AutoTotem] §aConfigured hotbar slot set to: §e" + slotNumber)
        );
    ...
    private static int setDelay(CommandContext<FabricClientCommandSource> context, String delayType) {
        ...
        switch (delayType) {
            case "doublehand":
                ...
                context.getSource().sendFeedback(
                    class_2561.method_43470("§6[AutoTotem] §aDouble hand delay set to: §e" + ticks + " ticks")
                );
                break;
            case "openinventory":
                AutoInventoryTotem.setOpenInventoryDelay(ticks);
                context.getSource().sendFeedback(
                    class_2561.method_43470("§6[AutoTotem] §aOpen inventory delay set to: §e" + ticks + " ticks")
                );
                break;
            case "switchtotems":
                AutoInventoryTotem.setSwitchTotemsDelay(ticks);
                context.getSource().sendFeedback(
                    class_2561.method_43470("§6[AutoTotem] §aSwitch totems delay set to: §e" + ticks + " ticks")
                );
                break;
            case "closeinventory":
                AutoInventoryTotem.setCloseInventoryDelay(ticks);
                context.getSource().sendFeedback(
                    class_2561.method_43470("§6[AutoTotem] §aClose inventory delay set to: §e" + ticks + " ticks")
                );
                break;
        }
    ...
    private static int showInfo(CommandContext<FabricClientCommandSource> context) {
        ...
        context.getSource().sendFeedback(class_2561.method_43470("§6§m-------------------§r §6[AutoTotem Info]§r §6§m-------------------"));
        context.getSource().sendFeedback(class_2561.method_43470("§eStatus: " + (AutoInventoryTotem.isModEnabled() ? "§aEnabled" : "§cDisabled")));
        context.getSource().sendFeedback(class_2561.method_43470("§eConfigured Slot: §b" + slot));
        context.getSource().sendFeedback(class_2561.method_43470("§eDouble Hand Delay: §b" + AutoInventoryTotem.getDoubleHandDelay() + " ticks"));
        context.getSource().sendFeedback(class_2561.method_43470("§eOpen Inventory Delay: §b" + AutoInventoryTotem.getOpenInventoryDelay() + " ticks"));
        context.getSource().sendFeedback(class_2561.method_43470("§eSwitch Totems Delay: §b" + AutoInventoryTotem.getSwitchTotemsDelay() + " ticks"));
        context.getSource().sendFeedback(class_2561.method_43470("§eClose Inventory Delay: §b" + AutoInventoryTotem.getCloseInventoryDelay() + " ticks"));
        context.getSource().sendFeedback(class_2561.method_43470("§6§m-----------------------------------------------------"));
